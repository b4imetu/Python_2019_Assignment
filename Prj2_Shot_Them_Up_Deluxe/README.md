...
#这是 ***Deluxe 豪华版***~~（快乐肥宅版）~~ 使用了小组成员定制的快乐素材（图片、音频），但是在自定义完成后，出现了加载图片存在白边问题，小组成员暂无法解决，可能影响游戏体验。
...
![效果截图1](<https://github.com/b4imetu/Python_2019_Assignment/raw/master/capture/Shot_Them_Up_Deluxe (1).jpg>)

![效果截图2](<https://github.com/b4imetu/Python_2019_Assignment/raw/master/capture/Shot_Them_Up_Deluxe (2).jpg>)

![效果截图3](<https://github.com/b4imetu/Python_2019_Assignment/raw/master/capture/Shot_Them_Up_Deluxe (3).jpg>)
